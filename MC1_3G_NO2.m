...
load('inputMCXG3_het_NO2.txt');
load('inputMCYG3_het_NO2.txt');
...
for sth = 1:num_simulations
    ...
    X = inputMCXG3_het_NO2((sth-1)*N*T+1:sth*N*T,:);
    Y = inputMCYG3_het_NO2((sth-1)*N*T+1:sth*N*T);
...
fileID1 = fopen('assign_G3_Het_N02.txt', 'w');
fileID2 = fopen('theta_G3_Het_NO2.txt', 'w');
